...
func Compile(name, addr, nt string, input io.Reader, emitAst bool, emitAstTypes bool, syslogUseCurrentYear bool, loc *time.Location) (*VM, error) {
	...
	vm := New(name, addr, nt, obj, syslogUseCurrentYear, loc)
	return vm, nil
}
